...
func setupMeterProvider(ctx context.Context, cfg otelConfig, res *resource.Resource) (ShutdownFunc, error) {
	tracingLogger.LogInfofFor("Setting up OTel MeterProvider: service=%s protocol=%s endpoint=%s", cfg.ServiceName, cfg.Protocol, cfg.Endpoint)
	...
	return func(ctx context.Context) error {
		tracingLogger.LogInfofFor("Shutting down OTel MeterProvider")

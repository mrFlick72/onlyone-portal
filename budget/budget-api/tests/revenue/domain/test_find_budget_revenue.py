...
def test_find_yearly_revenue(mocker: MockerFixture):
    ...
    mocked_user_name_resolver.get_user_name.return_value=mocked_user_name_resolver_response
    ...
    mocked_repository.find_by_data_range.assert_called_once_with(UserName("A_USER_NAME"), Date.first_date_of_month(Month.JANUARY(), Year(2021)),

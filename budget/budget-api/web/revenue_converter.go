...
func RevenueRepresentationToDomainModel(rep RevenueRepresentation) *revenue.Revenue {
	d, _ := date.DateFor(rep.Date)
	m, _ := money.MoneyFor(rep.Amount)
	return &revenue.Revenue{
		Id:     revenue.RevenueId(rep.Id),
		Date:   *d,
		Amount: m,
		Note:   rep.Note,
...
func RevenueDomainToRepresentationModel(r *revenue.Revenue) RevenueRepresentation {
...
func RevenueListDomainToRepresentationModel(list []revenue.Revenue) []RevenueRepresentation {

...
class Date:
    ...
    def plusYears(self, years: int) -> "Date":
        try:
            return Date(
    ...
    @staticmethod
    def iso_date_for(content: str) -> "Date":
        try:

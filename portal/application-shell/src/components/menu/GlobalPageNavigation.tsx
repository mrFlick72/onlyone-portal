...
import { BarChart, EventRepeat, FormatListBulleted, Money, Person } from '@mui/icons-material';
...
const GlobalPageNavigation: React.FC<GlobalPageNavigationProps> = ({ messages }) => (
    <>
        ...
        <MenuItem icon={<EventRepeat />} text={messages.scheduledExpense} link="/budget/scheduled-expense/index" />

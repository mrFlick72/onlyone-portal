Using hte Playwrite MCP I want to test the following scenario.
...
- you should verify that the login works with teh following AC:
  - we are logged in so the url is http://local.onlyone-portal.com:8070/index without keep to be redirected to vauthetnicator or callback url
  - you are into the home page that should be like in the screen in the assertions/home.png
